...
// File aids in dealing with the Parse server - this file is largely not used by the app 
...
// Post Relation
  ...
  static let ParseFlaggedContentToCampaign   = "toCampaign"
  ...
  static func timelineRequestForCurrentUser(range: Range<Int>, completionBlock: PFQueryArrayResultBlock) {
    ...
    static func campaignRequestForCurrentUser(completionBlock: PFQueryArrayResultBlock) {
        let campaignQuery = PFQuery(className: "Campaign")
        campaignQuery.whereKey("user", equalTo: PFUser.currentUser()!)
        campaignQuery.orderByDescending("createdAt")
        campaignQuery.findObjectsInBackgroundWithBlock(completionBlock)
    }
  ...
  */
  ...
  static func flagCampaign(user: PFUser, campaign: Campaign) {
    let flagObject = PFObject(className: ParseFlaggedContentClass)
    flagObject.setObject(user, forKey: ParseFlaggedContentFromUser)
    flagObject.setObject(campaign, forKey: ParseFlaggedContentToCampaign)
